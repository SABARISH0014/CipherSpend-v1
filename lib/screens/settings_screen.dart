...
>>>>>>> Stashed changes
  ...
  // --- [ UPGRADED NEON AI FORECAST CARD ] ---
  ...
  // --- UPDATED TRANSACTION ITEM WITH GLASS DECORATION ---
  Widget _buildTransactionItem(TransactionModel txn) {
    final date = DateTime.fromMillisecondsSinceEpoch(txn.timestamp);

    return Container(
      margin: const EdgeInsets.symmetric(horizontal: 16, vertical: 6), // Adjusted margin for breathing room
      child: Dismissible(
        key: Key(txn.hash),
        ...
        background: Container(
          ...
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(12), // Match glass border radius
          ),
        ...
        // Replaced Card with Container using Constants.glassDecoration
        child: Container(
          decoration: Constants.glassDecoration.copyWith(
            borderRadius: BorderRadius.circular(12),
          ),
          child: Material(
            color: Colors.transparent, // Ensures ink ripple isn't blocked
            child: ListTile(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        // [FIXED]: Squeezed title to prevent truncation
        titleSpacing: 16,
        title: const Text(
          "CipherSpend", 
        ...
        backgroundColor: Constants.colorSurface,
        actions: [
          // [FIXED]: Added constraints and padding to squish the icons together
          IconButton(
          ...
          const SizedBox(width: 8), // Tiny padding at the edge
        ],
      ),
