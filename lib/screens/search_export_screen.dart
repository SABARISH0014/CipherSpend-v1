    ...
    await showDialog(
      ...
      builder: (context) {
        return StatefulBuilder(builder: (context, setDialogState) {
          ...
          ).animate().scale(begin: const Offset(0.9, 0.9)).fade(duration: 200.ms);
        });
      },
    );
  }
        ...
        actions: [
          TapScaleWrapper(
            ...
            child: const Padding(
              ...
              child: Icon(Icons.download, color: Constants.colorPrimary),
            ),
          )
        ],
      ),
                  ...
                  children: [
                    TapScaleWrapper(
                      ...
                      child: Container(
                        ...
                        child: const Icon(Icons.filter_list, color: Constants.colorPrimary),
                      ),
                    ),
                    if (filterCount > 0)
                      Positioned(
            ...
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  ).animate().fade(delay: (30 * index).ms).slideX(begin: 0.1, curve: Curves.easeOutCubic);
                },
              ),
            ),
        ],
